<section class="about-hero text-center" data-aos="fade-in">
    <div class="container">
        <h1 class="display-4 fw-bold">Về CJ CGV Việt Nam 🎬</h1>
    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-6" data-aos="fade-left">
            <div class="text-center p-4">
                <div class="about-img bg-light d-flex align-items-center justify-content-center rounded shadow" style="height: 400px; font-size: 100px;">
                    🎟️
                </div>
            </div>
        </div>
    ...
    <div class="row g-4">
        <div class="col-md-6" data-aos="zoom-in-up" data-aos-delay="100">
            <div class="vision-mission-card text-center h-100 p-4 border rounded shadow-sm">
                <span class="vision-icon fs-1 mb-3 d-block">🌍</span>
    ...
    <div class="row">
        <div class="col-md-3 col-sm-6 mb-4" data-aos="flip-left" data-aos-delay="100">
            <div class="core-values-item text-center">
                <div class="value-icon fs-1 mb-3">🎦</div>
        ...
        <div class="col-md-3 col-sm-6 mb-4" data-aos="flip-left" data-aos-delay="400">
            <div class="core-values-item text-center">
                <div class="value-icon fs-1 mb-3">❤️</div>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6" data-aos="fade-up" data-aos-delay="100">
                <div class="team-card text-center">
                    <div class="team-avatar fs-1">👨‍💼</div>
                    <h5 class="mt-3">Trần Danh</h5>
