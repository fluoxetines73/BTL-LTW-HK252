<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card shadow-lg border-0 bg-white text-dark rounded-3">
                <div class="card-header text-white text-center py-3" style="background-color: var(--cgv-red);">
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="row border-bottom pb-4 mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            <p class="mb-2 text-dark"><i class="far fa-calendar-alt text-info me-2"></i><strong>Ngày chiếu:</strong> <?= date('d/m/Y', strtotime($showtime['start_time'])) ?></p>
                            <p class="mb-2 text-dark"><i class="far fa-clock text-info me-2"></i><strong>Giờ chiếu:</strong> <span class="badge bg-danger fs-6"><?= date('H:i', strtotime($showtime['start_time'])) ?></span></p>
                        </div>
                    </div>
                    ...
                    <!-- Tổng kết thanh toán -->
                    <div class="bg-light text-dark p-4 rounded-3 mb-4 text-center border">
                    ...
                    <form action="<?= BASE_URL ?>product/processPayment" method="POST">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn px-5 py-2 fw-bold text-white" style="background-color: var(--cgv-red);">
