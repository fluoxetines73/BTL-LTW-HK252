...
class AboutCoreValues extends Model {
    protected string $table = 'about_core_values';

    /**
     * Get all active core values ordered by sort_order
     * @return array
     */
    ...
    /**
     * Create new core value item
     * @param array $data
     * @return int|false
     */
    public function createItem(array $data): int|false {
        $sql = "INSERT INTO {$this->table} (icon_class, title, description, sort_order, is_active) 
                VALUES (:icon_class, :title, :description, :sort_order, :is_active)";
