...
/**
 * Admin Search Users
 * Tầm kiếm người dùng theo keyword
 */
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    ...
    <title><?= htmlspecialchars($title ?? 'Tìm kiếm Người dùng') ?></title>
    ...
    <div class="admin-container">
        ...
        <main class="main-content">
            ...
            <div class="admin-header">
                <div>
                    <h1><?= htmlspecialchars($title ?? 'Tìm kiếm Người dùng') ?></h1>
                    <small style="color: #999;">Từ khóa: "<?= htmlspecialchars($keyword ?? '') ?>"</small>
                </div>
