...
<section class="container py-5">
    <div class="mb-4">
        <h1 class="display-4 text-dark">Danh sách phim</h1>
    ...
    <div class="row g-4">
        ...
        <?php else: ?>
            <div class="col-12 text-center py-5">
                <p class="text-dark">Hiện chưa có phim nào trong danh sách.</p>
                <a href="<?= BASE_URL ?>" class="btn btn-outline-danger">Quay lại trang chủ</a>
            </div>
        <?php endif; ?>
    </div>
</section>
